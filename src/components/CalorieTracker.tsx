...
type CalorieTrackeProps = {
  activities: Activity[];
};

export default function CalorieTracker({ activities }: CalorieTrackeProps) {
  ...
  const total = useMemo(() => caloriesConsumed - caloriesBurned, [activities]);
